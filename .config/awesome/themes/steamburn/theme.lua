...
theme.wallpaper                                 = os.getenv("HOME") .. "/.wallpaper/wallpaper1.png"
juni_color = {
    cyan = "#005577",
    white = "#ffffff",
    green = "#073e19",
...
theme.fg_normal                                 = juni_color.white
--theme.fg_focus                                  = "#d88166"
theme.fg_focus                                  = "#8fb178"
theme.fg_urgent                                 = "#CC9393"
--theme.bg_normal                                 = juni_color.cyan
theme.bg_normal                                 = "#140c0b"
--theme.bg_focus                                  = juni_color.cyan
theme.bg_focus                                  = "#140c0b"
--theme.bg_urgent                                 = "#2a1f1e"
theme.bg_urgent                                 = juni_color.green
theme.border_width                              = dpi(5)
theme.border_normal                             = "#302627"
--theme.border_focus                              = "#c2745b"
theme.border_focus                              = juni_color.cyan
theme.border_marked                             = "#CC9393"
--theme.taglist_fg_focus                          = "#d88166"
theme.taglist_fg_focus                          = "#8fb178"
theme.tasklist_bg_focus                         = "#140c0b"
--theme.tasklist_bg_focus                         = juni_color.cyan
--theme.tasklist_fg_focus                         = "#d88166"
theme.tasklist_fg_focus                         = "#8fb178"
